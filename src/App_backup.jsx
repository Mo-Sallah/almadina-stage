                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                            ...
                            <div className="lg:col-span-4 space-y-4">
                                <div className="bg-white rounded-2xl border border-slate-150 p-5 shadow-sm sticky top-24">
                                    <h2 className="text-sm font-bold text-slate-900 mb-3 flex items-center gap-2 border-b border-slate-100 pb-2">
                                    ...
                                    {!selectedVideo ? (
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="bg-slate-50 rounded-xl p-4 border border-slate-150 space-y-3 text-right">
                                                ...
                                                <div className="relative">
                                                    <select
                                                        ...
                                                        className={`w-full bg-white font-normal border border-slate-200 rounded-xl text-xs focus:outline-none py-2.5 appearance-none ${lang === 'ar' ? 'pl-9 pr-3' : 'pr-9 pl-3'
                                                            }`}
                                                    >
                                            ...
                                            <button
                                                ...
                                                className="w-full py-3 bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-xl transition-all text-xs shadow-md"
                                            >
                                                {t.saveEvaluation}
                                            </button>
